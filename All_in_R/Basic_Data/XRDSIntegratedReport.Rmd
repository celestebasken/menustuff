...
print(results$report_objs$category_frequency)

print(results$exported$s3_XRDS$category_table)
...
scenario3c3.png <- results$report_objs$plots[[scenario3_name]]$sus_vs_conv_spend
ggsave("scenario_outputs_cafe3/scenario3c3.png", plot = scenario3c3.png, width = 10, height = 4, dpi = 300)
