...
## Part 0: Load data, Current menu freq figures
...
write.csv(optimization, file = "PreRG_outputs/optimization_scenario2.csv", row.names = FALSE)
...
write.csv(optimization, file = "PreRG_outputs/optimization_scenario3.csv", row.names = FALSE)
...
write.csv(optimization, file = "PreRG_outputs/optimization_scenario4.csv", row.names = FALSE)
